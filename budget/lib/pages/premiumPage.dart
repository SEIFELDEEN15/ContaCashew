...
openManagePurchase() {
  if (appStateSettings["purchaseID"] == productIDs["lifetime"]) {
    ...
    openUrl(
        "https://play.google.com/store/account/subscriptions?sku=cashew.pro.monthly&package=com.eliazavatta.contaspicci");
  } else if (appStateSettings["purchaseID"] == productIDs["yearly"]) {
    openUrl(
        "https://play.google.com/store/account/subscriptions?sku=cashew.pro.yearly&package=com.eliazavatta.contaspicci");
  } else {
